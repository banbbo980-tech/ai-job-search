...
3. Inspect the rendered PDF with the available PDF viewing or rendering capability and visually check: signature fits at the bottom, no text cut off, bullet font matches body
